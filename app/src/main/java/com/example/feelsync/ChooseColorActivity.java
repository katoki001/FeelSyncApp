...
public class ChooseColorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(v -> {
            if (!allColorsChosen()) {
                ...
                Toast.makeText(this, "All colors selected and saved!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showWarningDialog() {
        new MaterialAlertDialogBuilder(this)
                .setTitle("Select All Colors")
                .setMessage("Please choose a color for each mood before proceeding.")
